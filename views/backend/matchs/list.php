...
<table class="table table-striped"><thead><tr><th>Utilisateur</th><th>Profil correspondant</th><th>Actions</th></tr></thead><tbody><?php foreach ($matchs as $match) { ?><tr><td><?php echo (int) $match['idUserM1']; ?></td><td><?php echo (int) $match['idUserM2']; ?></td><td><a href="edit.php?idUserM1=<?php echo (int) $match['idUserM1']; ?>&idUserM2=<?php echo (int) $match['idUserM2']; ?>" class="btn btn-warning btn-sm">Modifier</a> <a href="delete.php?idUserM1=<?php echo (int) $match['idUserM1']; ?>&idUserM2=<?php echo (int) $match['idUserM2']; ?>" class="btn btn-danger btn-sm">Supprimer</a></td></tr><?php } ?></tbody></table></main>
